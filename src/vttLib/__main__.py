...
from vttLib import VTTLibArgumentError, vtt_compile, vtt_dump, vtt_merge
...
class PkgVersionAction(_VersionAction):
    def __call__(self, parser, namespace, values, option_string=None):
        ...
        super(PkgVersionAction, self).__call__(parser, namespace, values, option_string)


def main(args=None):
    parser = ArgumentParser(
        prog="python -m vttLib",
        description="Dump, merge or compile Visual "
    ...
    parser_merge.add_argument(
        "infile",
        metavar="INPUT.ufo",
        help="the source UFO font containing " "VTT TSI* tables in .ttx format",
    )
    ...
    parser_merge.add_argument(
        ...
        nargs="?",
        metavar="OUTPUT.ttf",
        help="the TTF to merge " 'data with (default: INPUT + ".ttf")',
    )
